...
var faveColors = ['green', 'blue', 'black'];
...
var me = {
    firstName: 'Lauren',
    superHeroName: 'TheMumbler',
    homeTown: 'Layton',
    superPowers: ['overthinking', 'talking fast', 'daydreaming'],
...
// const checker = setColor(faveColors);
// console.log(checker);
//////////////////Step 5////////////////////
...
const checker = setPowers(me.superPowers);
console.log(checker);
